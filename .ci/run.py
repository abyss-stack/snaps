...
def main():
    ...
    git_cfg = GitConfig(remote="origin", branch="dev:main")
        ...
        with chdir(project_root):
            ...
            if readme_path.exists():
                ...
                install_block = (
                    ...
                    "```sh\n"
                    f"sudo curl -L -o /usr/local/bin/abyss-snaps https://github.com/abyss-stack/snaps/releases/download/v{TARGET_VERSION}/abyss-snaps \\\n"
